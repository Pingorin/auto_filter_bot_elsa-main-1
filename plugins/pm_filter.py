...
async def pm_search(client, message):
    if IS_PM_SEARCH:
        ...
        await message.reply_text("<b>🔍 Search in Group 🔍https://t.me/searchmoviehere</b>")
...
async def next_page(bot, query):
    ...
    # Add a separate button with a URL link at the top
    btn.insert(0, [
        InlineKeyboardButton("🌐 New Button", url="https://example.com")  # Replace with your desired text and URL
    ])
    # Existing buttons
    btn.insert(1, [
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        btn= [[
            InlineKeyboardButton("ᴡᴀᴛᴄʜ ᴏɴʟɪɴ 🧿", url=online),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Cᴏɴᴛᴀᴄᴛ 👮', url='https://t.me/Jain_shabb')
        ]] 
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(                     
